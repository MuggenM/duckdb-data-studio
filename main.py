...
def explorer_colored_svg():
    from fastapi import Response
    svg_content = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><rect x="2" y="2" width="20" height="20" rx="3" fill="none" stroke="#38BDF8" stroke-width="2" /><line x1="2" y1="9" x2="22" y2="9" stroke="#38BDF8" stroke-width="1.5" stroke-dasharray="1 1" /><line x1="2" y1="15" x2="22" y2="15" stroke="#38BDF8" stroke-width="1.5" stroke-dasharray="1 1" /><line x1="9" y1="2" x2="9" y2="22" stroke="#38BDF8" stroke-width="1.5" stroke-dasharray="1 1" /><line x1="15" y1="2" x2="15" y2="22" stroke="#38BDF8" stroke-width="1.5" stroke-dasharray="1 1" /><path d="M4 18 l4 -5 l5 3 l7 -9" fill="none" stroke="#F59E0B" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" /><circle cx="4" cy="18" r="2" fill="#F59E0B" /><circle cx="8" cy="13" r="2" fill="#F59E0B" /><circle cx="13" cy="16" r="2" fill="#F59E0B" /><circle cx="20" cy="7" r="2.5" fill="#F59E0B" /></svg>'''
    return Response(content=svg_content, media_type="image/svg+xml")
