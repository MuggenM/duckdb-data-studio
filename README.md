...
* **[JupyterLab](https://jupyter.org/)**: Enables embedded Python notebook workspaces, pre-configured with the **`duckrun`** library to execute optimized local Pandas DataFrame and S3 Delta Lake query operations.
